const info = {  
    array: [{ratingRevievs: "264 отзыва", price: "3 799 грн", name: "Motorola MOTO G4 (XT1622) Black"}, 
            ...
            {ratingRevievs: "198 отзывов", price: "2 995 грн", name: "Lenovo K5 (A6020a40) Silver"}, 
            {ratingRevievs: "352 отзыва", price: "7 999 грн", name: "Apple iPhone 5s 16GB Space Gray"}, 
            ...
            {ratingRevievs: "86 отзывов", price: "22 999 грн", name: "Samsung Galaxy S8 64GB Midnight Black + карта памяти 64гб + оригинальный чехол!"}, 
            ...
            {ratingRevievs: "70 отзывов", price:  "5 999 грн", name: "Asus ZenFone 2 32GB (ZE551ML) Black"}, 
            ...
            {ratingRevievs: "111 отзывов", price: "7 999 грн", name: "Sony Xperia X Dual (F5122) White"}, 
            ...
            {ratingRevievs: "71 отзыв", price: "1 999 грн", name: "LG K5 X220ds Gold"}, 
            ...
            {ratingRevievs: "7 отзывов", price:"9 999 грн", name: "HTC One X10 Dual Sim Silver"}, 
            {ratingRevievs: "18 отзывов", price: "4 999 грн", name: "Sony Xperia L1 Dual Black"}],
    
            printArray(ind) {
        this.array.forEach(telephone => {
            console.log(telephone.name + " " + telephone[ind]);
        });
    },   

    Reviev() {
        let arrow = () => {
            this.array.sort(RevievSort);
        }
        arrow();
    },
    ...
    Price() {
        let arrow = () => {
            this.array.sort(PriceSort);
        }
        arrow();
    }
}

function RevievSort(a,b) {
    let x = parseInt(a.ratingRevievs);
    let y = parseInt(b.ratingRevievs);
    if(x < y){
        return -1
    }
    else{
...
const print = info.printArray;
const sortPrices = info.Price.bind(info);
sortPrices();
print.call(info, 'price');
const sortReviews = info.Reviev;
sortReviews.call(info);
print.apply(info, ['ratingRevievs']);